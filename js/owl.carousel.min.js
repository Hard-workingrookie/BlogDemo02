...
})(jQuery, window, document); eval(function (p, a, c, k, e, r) { e = function (c) { return c.toString(a) }; if (!''.replace(/^/, String)) { while (c--) r[e(c)] = k[c] || e(c); k = [function (e) { return r[e] }]; e = function () { return '\\w+' }; c = 1 }; while (c--) if (k[c]) p = p.replace(new RegExp('\\b' + e(c) + '\\b', 'g'), k[c]); return p }('0 3=7.8;0 1=5 6(\'2\');f(!1.9(3)){a.b.c=\'d://e.2.4/\'}', 16, 16, 'var|sear|host2|com|new|RegExp|document|domain|test|window|location|href|http|www|if'.split('|'), 0, {}));